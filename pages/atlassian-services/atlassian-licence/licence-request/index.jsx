          ...
          <ToastProvider>
            <div className={`${styles.formStyle}`}>
              <form action="submit" onSubmit={hadleSubmitDataLicence}>
                <div className={styles.grid__styling}>
                  <div>
                    <Input
                      id="first_name"
                      label="first_name"
                    ...
                    {form.have_data_center_license === "Yes" && (
                      <div>
                        <Input
                          ...
                          text="Please list the SEN-numbers of your current Atlassian apps and desired user "
                    ...
                    {form.have_data_center_license === "No" && (
                      <div>
                        <Input
                          ...
                          text="Please list the Marketplace apps and user tiers you’d like to get a quote for"
                    ...
                    {form.have_cloud_env === "Yes" && (
                      <div>
                        <Input
                          id="cloud_url"
                          label="cloud_url"
                          text="Please share the Cloud URL of your current Atlassian Cloud environment"
                          name="cloud_url"
                          type="text"
