            ...
            <div className={styles.privacy}>
              <div className="">
                ...
                <p className="text-justify">
                  ...
                  Alluvium ("us", "we", "our") uses and protects the data you
                  provide to us when you visit and use{" "}
                  <a target="_blank" href="https://alluvium.net/">
                    https://alluvium.net
                  </a>{" "}
                  ("website", "service"). We reserve the right to change this
                  policy at any given time, of which you will be promptly
                  updated. If you want to make sure that you are up to date with
                  the latest changes, we advise you to frequently visit this
                  page.
                </p>
              </div>
              ...
              <div className="">
                ...
                <p className="text-justify">
                  Alluvium is committed to securing your data and keeping it
                  confidential. Alluvium has done all in its power to prevent
              ...
              <div className="">
                ...
                <p className="text-justify">
                  ...
                  time on, and websites you visit). <br />
                  ...
                  can provide a better experience for you. If you want to
                  disable cookies, you can do it by accessing the settings of
              ...
              <div className="">
                ...
                <p className="text-justify">
                  ...
                  click on these links Alluvium is not held responsible for your
              ...
              <div className="">
                ...
                <p className="text-justify">
                  ...
                  don't want to disclose your personal information. If you have
                  already agreed to share your information with us, feel free to
                  contact us via email and we will be more than happy to change
                  this for you. <br />
                  Alluvium will not lease, sell or distribute your personal
