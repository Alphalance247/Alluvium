...
export default function CaseStudy({ caseStudy }) {
  ...
  return (
    <div className={styles.caseStudyPage}>
      ...
      <main>
        <section className={`container-fluid ${styles.heroSection}`} style={{backgroundImage: `url(${details.displayImage})`}}>
            ...
            <div className="container py-3 py-md-0 d-flex justify-content-between align-items-center">
              <div className="me-auto d-none d-md-block">
                <ul className="list-unstyled d-flex gap-md-3 gap-lg-5 mb-0 align-items-center">
                  <li
                    className={
                      activeNav === "overview" ? styles.active : styles.inActive
                    }
                  >
                    <Link href={"#overview"}>
                      <a>Overview</a>
          ...
          >
            <div className="container mx-auto my-5">
              <div className="">
                ...
                <div><p>{details.caseStudyChallenge}</p></div>
              </div>
              <div className="">
                ...
                <div>
                  ...
                  <span>
                    {details.caseStudySolutionsParagraphs?.map((paragraph) => (
