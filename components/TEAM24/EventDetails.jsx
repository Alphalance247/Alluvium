      ...
      <div className={styles.EventGuide}>
        <div className={styles.EventTheme}>
          <div>
            ...
            <p>
              At Booth No. 53, we're bringing the difference to you! Prepare to
              be dazzled by our exclusive goodies, including traditional gele,
              fila, coasters, and more. As you soak up the beauty, expertise,
              and pure fun, you'll also take home souvenirs that will keep the
              magic of Alluvium alive even after Team '24 ends.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              experience, service delivery, and collaborative work management. 
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              part of the Alluvium community. Open doors to endless
