    ...
    >
      <div className={styles.topBar}>
        <div className={styles.flexBetween}>
          <div>
            <button onClick={zoomIn} title="Zoom In">
              <img src="/assets/cloud-connect/icons/basil_zoom-in-outline.svg" />
            </button>
        ...
        <button onClick={onClose} title="Close" className={styles.closeBtn}>
          <img src="/assets/cloud-connect/icons/Close.svg" alt="Close" />
        </button>
      </div>
      <div className={styles.modalContent}>
        ...
        <button className={styles.navButton} onClick={onNext}>
          <img src="/assets/cloud-connect/icons/Right arrow.svg" alt="Right" />
        </button>
      </div>
    </div>
  );
