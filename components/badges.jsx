            ...
            <div className="d-md-none">
                <div className={styles.badges_cover}>
                    <div className={styles.badges}>
                        ...
                        <Image src={"/assets/atlassian-badges/aws-qualified-software-partner.png"} loading="eager" priority width={198/2} height={198/2} alt={"AWS Qualified Software Partner"} />
                        <Image src={"/assets/atlassian-badges/atl-expert.png"} className={styles.stroke} loading="eager" priority width={198/2} height={198/2} alt={"Atlassian Certified Expert"} />
                        <Image src={"/assets/atlassian-badges/gcp-02.jpeg"} className={styles.stroke} loading="eager" priority width={198/2} height={198/2} alt={"Google Cloud Certified, Cloud Digital Leader"} />
                        <Image src={"/assets/atlassian-badges/atl.png"} className={styles.stroke} loading="eager" priority width={198/2} height={198/2} alt={"Atlassian Certified Jira Administrator for Cloud"} />
                        <Image src={"/assets/atlassian-badges/atl-cloud.png"} className={styles.stroke} loading="eager" priority width={198/2} height={198/2} alt={"Atlassian Certified Confluence Administrator for Cloud"} />
                        <Image src={"/assets/atlassian-badges/atl-jira-project.png"} className={styles.stroke} loading="eager" priority width={198/2} height={198/2} alt={"Atlassian Platinum Market Place Partner"} />
                    </div>
                </div>
            </div>
        </>
